...
class EnKF_wrap():
    def __init__(self):
        ...
        self._var_name_units_map = {"basin_area_km2":['basin_area_km2','km2'],
                                    "surface_runoff_ratio":['surface_runoff_ratio','%'],                                    "soil_reservoir_storage_deficit_m":['soil_reservoir_storage_deficit_m','m'],
    ...
    def update(self):
        ...
        if soil_moisture_def_diff_m>=0:
            ...
            self.soil_storage_deficit  = self.soil_storage # set by CFE
