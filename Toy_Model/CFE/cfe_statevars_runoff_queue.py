...
class CFE():
    ...
    def run_cfe(self, cfe_state):
        ...
        #print("used change",cfe_state.time_state_var_change)                    
        # cfe_state.soil_reservoir_storage_deficit_m=cfe_state.soil_reservoir_storage_deficit_m  * cfe_state.time_state_var_change                                   
...
#        cfe_state.runoff_queue_m_per_timestep[-1] = 0
        ...
        for i in range(cfe_state.num_giuh_ordinates):
            ...
            cfe_state.runoff_queue_m_per_timestep[i] += cfe_state.giuh_ordinates[i] * (cfe_state.surface_runoff_depth_m* cfe_state.time_state_var_change) #multiply by ##% for state var change
