...
class EnKF_wrap():
    def __init__(self):
        ...
        self._input_var_names = [
            'x', 'P','z','F', 'dt','N','look_up_table','max_state_var_change_soilResDef','soil_storage_avail_m','soil_reservoir_storage_deficit_m']
    ...
    def update(self):
        ...
        if state_var_change_soilResDef >  self.max_soil_res_def:
            ...
            orig =self.x
            resulted=self.res
            basin_area_m2 # define config file
             
            total_volume_change_ft3 = (orig-resulted)*3600
            total_volume_change_m3 =3.28*(10**3)*total_volume_change
